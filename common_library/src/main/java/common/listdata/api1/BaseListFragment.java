 ...
 */
public abstract class BaseListFragment<Model, Adapter extends BasicAdapter<Model>>  extends BaseFragment implements IViewControl, IViewListHelper {
    private IFragmentListHelper iFragmentListHelper =new FragmentListHelperImpl<Model, Adapter>(){
        ...
        public void onLoadMore(int pageNum) {
            BaseListFragment.this.onLoadMore(pageNum);
        }
        ...
        public Class<?> getViewClass() {
            return BaseListFragment.this.getViewClass();
        }
        ...
        public int getFirstPage() {
            return BaseListFragment.this.getFirstPage();
        }
        ...
        public int getPageSize() {
            return BaseListFragment.this.getPageSize();
        }
        ...
        public boolean isLastPageDependClient() {
            return BaseListFragment.this.isLastPageDependClient();
        }
        ...
        public boolean isLastPage() {
            return BaseListFragment.this.isLastPage();
        }
        ...
        public <T> T getView(int id, Class<T> clazz) {
            return BaseListFragment.this.getView(id,clazz);
        }

        @Override
        public Context getContext() {
            return BaseListFragment.this.getContext();
        }
    };
    ...
    @Override
    public Class<?> getViewClass() {
        return BaseListFragment.this.getClass();
    }
